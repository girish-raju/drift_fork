...
typedef SqliteKeywordNameNative =
    Int32 Function(Int32, Pointer<Pointer<Uint8>>, Pointer<Int32>);
typedef SqliteKeywordName =
    int Function(int, Pointer<Pointer<Uint8>>, Pointer<Int32>);
...
void main() {
  ...
  test('recognizes all sqlite keywords', () {
    final keywordCount = library
        .lookupFunction<SqliteKeywordCountNative, SqliteKeywordCount>(
          'sqlite3_keyword_count',
        )();
    final nameFunction = library
        .lookupFunction<SqliteKeywordNameNative, SqliteKeywordName>(
