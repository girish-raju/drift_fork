...
void main() {
  ...
  test('vacuum', () {
    ...
    testStatement(
      'VACUUM INTO ?',
      VacuumStatement(into: NumberedVariable(null)),
    );
    testStatement(
      'VACUUM schema INTO ?',
  ...
  test('analyze', () {
    ...
    testStatement(
      'ANALYZE a.b',
      AnalyzeStatement(schemaName: 'a', elementName: 'b'),
    );
  });
  ...
  test('pragma', () {
    ...
    testStatement(
      'PRAGMA foo.bar',
      PragmaCommand(schemaName: 'foo', pragmaName: 'bar'),
    );
