...
class Category extends DataClass implements Insertable<Category> {
  ...
  CategoriesCompanion toCompanion(bool nullToAbsent) {
    return CategoriesCompanion(id: Value(id), title: Value(title));
  }
  ...
  Category copyWith({int? id, String? title}) =>
      Category(id: id ?? this.id, title: title ?? this.title);
...
class CategoriesCompanion extends UpdateCompanion<Category> {
  ...
  CategoriesCompanion copyWith({Value<int>? id, Value<String>? title}) {
    return CategoriesCompanion(id: id ?? this.id, title: title ?? this.title);
  }
...
typedef $$CategoriesTableCreateCompanionBuilder =
    CategoriesCompanion Function({Value<int> id, required String title});
typedef $$CategoriesTableUpdateCompanionBuilder =
    CategoriesCompanion Function({Value<int> id, Value<String> title});
    ...
    : super(
        TableManagerState(
          ...
          updateCompanionCallback:
              ...
              }) => CategoriesCompanion(id: id, title: title),
          createCompanionCallback:
              ({Value<int> id = const Value.absent(), required String title}) =>
                  CategoriesCompanion.insert(id: id, title: title),
          withReferenceMapper: (p0) => p0
              .map((e) => (e.readTable(table), BaseReferences(db, table, e)))
              .toList(),
          prefetchHooksCallback: null,
