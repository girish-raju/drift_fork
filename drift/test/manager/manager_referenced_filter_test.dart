...
void main() {
  ...
  setUp(() async {
    ...
    stores = await _storeData.mapAsyncAndAwait(
    ...
    final categories = await _todoCategoryData.mapAsyncAndAwait((
      categoryData,
    ) async {
      await db.managers.categories.createReturning(
        (o) => o(
    ...
    final todos = await _todosData.mapAsyncAndAwait((todoData) async {
      await db.managers.todosTable.createReturning(
        (o) => o(
