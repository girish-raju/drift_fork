...
PrimaryKeyColumn _$PrimaryKeyColumnFromJson(Map json) =>
    PrimaryKeyColumn(json['is_auto_increment'] as bool);

Map<String, dynamic> _$PrimaryKeyColumnToJson(PrimaryKeyColumn instance) =>
    <String, dynamic>{'is_auto_increment': instance.isAutoIncrement};
...
) => <String, dynamic>{'dart_expression': instance.dartExpression.toJson()};
