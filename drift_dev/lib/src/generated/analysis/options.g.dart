...
DriftOptions _$DriftOptionsFromJson(Map json) => $checkedCreate(
  ...
  ($checkedConvert) {
    ...
    final val = DriftOptions(
      ...
      incrementalGeneration: $checkedConvert(
        'incremental_generation',
        (v) => v as bool? ?? false,
      ),
      incrementalCacheDir: $checkedConvert(
        'incremental_cache_dir',
        (v) => v as String?,
      ),
  ...
  fieldKeyMap: const {
    ...
    'incrementalCacheDir': 'incremental_cache_dir',
...
Map<String, dynamic> _$DriftOptionsToJson(
  ...
  'incremental_generation': instance.incrementalGeneration,
  'incremental_cache_dir': instance.incrementalCacheDir,
