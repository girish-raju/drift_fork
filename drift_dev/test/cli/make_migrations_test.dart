...
targets:
  \$default:
    builders:
      ...
      File(
        p.join(project.root.path, 'lib/db.dart'),
...
targets:
  \$default:
    builders:
      ...
      await d
          .file(
            'app/custom_test/my_database/migration_test.dart',
            IsValidDartFile(anything),
          )
          .validate();
    });
...
''');
      ...
      expect(
        ...
        prints(
          allOf(
            contains(
              'Your latest migration might benefit from a test with data',
            ),
